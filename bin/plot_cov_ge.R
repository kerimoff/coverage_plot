...
if (FALSE) {
  opt = list()
  opt$n = "Alasoo_2018"
  opt$f = "/Users/kerimov/Work/temp_files/txrevise_stuff/Alasoo_2018_3Apr/susie/Alasoo_2018_ge_macrophage_IFNg.purity_filtered.txt.gz"
  opt$s = "/Users/kerimov/Work/GitHub/SampleArcheology/studies/cleaned/Alasoo_2018.tsv"
  opt$p = "/Users/kerimov/Work/temp_files/txrevise_stuff/Alasoo_2018_3Apr/gene_counts_Ensembl_105_phenotype_metadata.tsv.gz"
  opt$q = "macrophage_IFNg"
  opt$o = "/Users/kerimov/Work/temp_files/txrevise_stuff/Alasoo_2018_3Apr/plots_data_generate_GE"
  ...
  opt$u = "/Users/kerimov/Work/temp_files/txrevise_stuff/Alasoo_2018_3Apr/qcnorm/Alasoo_2018.macrophage_IFNg_ge.tsv.gz"
  opt$a = "/Users/kerimov/Work/temp_files/txrevise_stuff/Alasoo_2018_3Apr/sumstats/Alasoo_2018_ge_macrophage_IFNg.all.tsv.gz"
...
for (index in 1:nrow(highest_pip_vars_per_cs)) {
  ...
  message("index: ", index, ", gene_phenotype_id: ", ss_oi$molecular_trait_id, ", variant: ", ss_oi$variant)
  ...
  boxplot_facet <- ggplot2::ggplot(track_data_study_box_wrap, 
    ...
    ggplot2::ylab(paste0("Expression ", ss_oi$group_id, " gene (", ss_oi$gene_name, ")")) +
  ...
  ggplot2::ggsave(path = path_plt, filename = filename_plt_box_facet, plot = boxplot_facet, device = "pdf", width = 6, height = 6)
