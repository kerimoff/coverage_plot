...
if (FALSE) {
  ...
  opt$o = "/Users/kerimov/Work/temp_files/txrevise_stuff/Alasoo_2018_3Apr/plots_data_generate_TX"
...
if (study_name == "Lepik_2017") {
  ...
  boxplot_facet <- ggplot2::ggplot(track_data_study_box_wrap, 
    ...
    ggplot2::ylab(paste0("Usage of transcripts of ", ss_oi$group_id, " gene\n(", ss_oi$gene_name, " gene region)")) +
  ...
  plot_rel_height = ifelse(plot_rel_height < 8, 8, plot_rel_height)
  ggplot2::ggsave(path = path_plt, filename = filename_plt_box_facet, plot = boxplot_facet, device = "pdf", width = plot_rel_height, height = plot_rel_height)
